    ...
    )
{
    ...
    *pu4SetInfoLen = 1;
    ...
    pucScanType = pvSetBuffer; //set force to 0(PASSIVE SCAN);

    prAdapter->ucScanType= 0;//SCAN_TYPE_PASSIVE_SCAN;// ((UINT_8)pucScanType[0]);
    ...
    )
{
    ...
    *pu4SetInfoLen = 1;
    ...
    prAdapter->ucScanType= 1;//SCAN_TYPE_PASSIVE_SCAN;// ((UINT_8)pucScanType[0]); 
