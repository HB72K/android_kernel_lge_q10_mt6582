...
// [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
#if defined(CONFIG_BACKLIGHT_LM3639) //LGE_CHANGE: [2014-10-29] yonghwan.lym@lge.com, lm3639 flash enable
...
// LGE_CHANGE_S: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
#elif defined(CONFIG_LEDS_RT4832)
extern void rt4832_flash_strobe_en();
extern void rt4832_flash_strobe_prepare(char OnOff,char ActiveHigh);
extern void rt4832_flash_strobe_level(char level);
// LGE_CHANGE_E: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
#endif
// [LGE_UPDATE_E] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
...
int FL_Enable(void)
{
    ...
    #elif defined(CONFIG_LEDS_RT4832)
         rt4832_flash_strobe_prepare(2,1); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
     }
     else  //strobe mode
     {
    ...
    #elif defined(CONFIG_LEDS_RT4832)
         rt4832_flash_strobe_prepare(1,1); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
*/
    ...
    #if defined(CONFIG_BACKLIGHT_LM3639) //LGE_CHANGE: [2014-10-29] yonghwan.lym@lge.com, lm3639 flash enable
        lm3639_flash_strobe_en(); // [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_BACKLIGHT_LM3632)
        lm3632_flash_strobe_en(); // [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_LEDS_RT4832)
        rt4832_flash_strobe_en(); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
{
    #if defined(CONFIG_BACKLIGHT_LM3639) //LGE_CHANGE: [2014-10-29] yonghwan.lym@lge.com, lm3639 flash enable
        lm3639_flash_strobe_prepare(0,0); // [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_BACKLIGHT_LM3632)
        lm3632_flash_strobe_prepare(0,0); // [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_LEDS_RT4832)
        rt4832_flash_strobe_prepare(0,0); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
///////////////////////
    ...
    */
    ...
    #if defined(CONFIG_BACKLIGHT_LM3639) //LGE_CHANGE: [2014-10-29] yonghwan.lym@lge.com, lm3639 flash enable
    lm3639_flash_strobe_en(); //[LGE_UPDATE] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_BACKLIGHT_LM3632)
    lm3632_flash_strobe_en(); //[LGE_UPDATE] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_LEDS_RT4832)
    rt4832_flash_strobe_en(); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
int FL_dim_duty(kal_uint32 duty)
{
    ...
    g_duty =  duty;
    #if defined(CONFIG_BACKLIGHT_LM3639) //LGE_CHANGE: [2014-10-29] yonghwan.lym@lge.com, lm3639 flash enable
    lm3639_flash_strobe_level((char)duty); //[LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_BACKLIGHT_LM3632)
    lm3632_flash_strobe_level((char)duty); //[LGE_UPDATE_S] [kipo.yun@lge.com] [2014-05-10] Enable Flash Driver
    #elif defined(CONFIG_LEDS_RT4832)
    rt4832_flash_strobe_level((char)duty); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
int FL_Init(void)
{
    ...
    #elif defined(CONFIG_LEDS_RT4832)
     rt4832_flash_strobe_prepare(1,1); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
     rt4832_flash_strobe_level((char)32); // LGE_CHANGE: [2015-10-08] yonghwan.lym@lge.com, flashlight(rt4832) enable
    #endif
...
{
   int iFlashType = (int)FLASHLIGHT_NONE; //[LGE_UPDATE] [yonghwan.lym@lge.com] [2014-02-20] Enable Flash Driver
    int i4RetValue = 0;
    int ior_shift;
    int iow_shift;
    int iowr_shift;
