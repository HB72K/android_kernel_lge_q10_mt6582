...
void config_misc_info(int md_id, unsigned int base[], unsigned int size)
{
    ...
    if(NULL != base) {
		...
		/* sbp_interface */
        printk("jjm_debug : g_lge_sim_num = %s\n", g_lge_sim_num);
        memcpy((char*)&(misc_info.feature_5_val[0]), g_lge_sim_num, 4); /* SIM count */

        misc_info.support_mask |= (FEATURE_SUPPORT<<(MISC_MD_SBP_SETTING_2*2));

		printk("jjm_debug : config_misc_info : misc_info.feature_4_val[0] = %s, misc_info.feature_4_val[1] = %s, misc_info.feature_4_val[2] = %s, misc_info.feature_4_val[3] = %s, misc_info.feature_8_val[0] = %s\n", (char *)(&misc_info.feature_4_val[0]), (char *)(&misc_info.feature_4_val[1]), (char *)(&misc_info.feature_4_val[2]), (char *)(&misc_info.feature_4_val[3]), (char *)(&misc_info.feature_8_val[0]));
