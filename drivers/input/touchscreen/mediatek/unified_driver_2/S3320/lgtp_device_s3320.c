...
****************************************************************************/
/* Enable TCI Debug */
#if !defined(TARGET_MT6582_Y70) && !defined(TARGET_MT6582_Y90) && !defined(TARGET_MT6732_C90) && !defined(TARGET_MT6582_M23G)
...
static const char defaultFirmware[] = "synaptics/m23g/PLG465-V1.11-PR1815155-DS5.2.12.0.13-4005018B.img";
#else
