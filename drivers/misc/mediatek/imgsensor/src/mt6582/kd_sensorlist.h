...
UINT32 HI842_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc); // LGE_CHANGE: [2015-10-01] yonghwan.lym@lge.com, Add camera(hi842)
...
#endif
// LGE_CHANGE_S : [2015-10-01] yonghwan.lym@lge.com, Add camera(hi842)
#if defined(HI842_MIPI_RAW)
    {HI842_SENSOR_ID, SENSOR_DRVNAME_HI842_MIPI_RAW,HI842_MIPI_RAW_SensorInit},
#endif
// LGE_CHANGE_E : [2015-10-01] yonghwan.lym@lge.com, Add camera(hi842)
