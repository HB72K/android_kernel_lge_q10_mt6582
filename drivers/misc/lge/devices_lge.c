...
#if defined (TARGET_MT6582_B2L) || defined(TARGET_MT6582_L80)\
|| defined (TARGET_MT6582_Y50) || defined (TARGET_MT6582_Y70)\
|| defined (TARGET_MT6582_Y90) || defined (TARGET_MT6582_M23G)
...
{
    if(lge_cable == NO_INIT_CABLE)
		return LGE_BOOT_MODE_QEM_UNKNOWN;
	else
