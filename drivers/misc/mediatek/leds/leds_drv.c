...
|| defined(TARGET_MT6582_P1S3G) || defined(TARGET_MT6582_M23G)
...
#if defined(TARGET_MT6582_Y90) \
|| defined(TARGET_MT6732_C90) || defined(TARGET_MT6582_B2L) \
|| defined(TARGET_MT6582_P1S3G) || defined(TARGET_MT6582_M23G)  /* LGE_BSP_COMMON sangcheol.seo@lge.com 140520 : LED */
void mt_led_off()
{
	struct cust_mt65xx_led *cust_led_list = mt_get_cust_led_list();
...
|| defined(TARGET_MT6582_Y90) || defined(TARGET_MT6582_B2L) \
|| defined(TARGET_MT6582_P1S3G) || defined(TARGET_MT6582_M23G)  /* LGE_BSP_COMMON LGE_CHANGE_S 140303 jongwoo82.lee : interface for HW tunning */
