...
#if 1 //sangcheol.seo@lge.com 20150407 show panel info
static ssize_t show_panel_type(struct device *device,
			 struct device_attribute *attr, char *buf)
{
	//int panel_type = lge_get_panel(); //need to implement this if needed.

	return snprintf(buf, PAGE_SIZE, "LGD - DB7400 \n");
}
#endif
...
#endif
	__ATTR(panel_type, S_IRUGO|S_IWUSR, show_panel_type, NULL), //sangcheol.seo@lge.com 20150407
