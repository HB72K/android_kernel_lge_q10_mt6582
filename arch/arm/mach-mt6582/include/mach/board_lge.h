...
#define PROTECTION_RAM_SIZE			0x10000000 // 1.5GB Protection size 0xB0000000 - 0xBFFFFFFF
#define RANK_SIZE_1_5GB 				0x30000000 // 1.5GB rank size : 0x30000000, rank number : 2
#else
...
enum lge_boot_mode_type lge_get_boot_mode_with_cable(void);
