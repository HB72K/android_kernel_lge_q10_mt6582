...
// [LGE_UPDATE_S] [kipo.yun@lge.com] [2014-10-25] AT command added for main/sub camera to prevent mixed items
                    ...
                    switch (sensorID) {
                        ...
                        case 0xB8:
                            ...
                            PK_DBG(" Sub Sensor found ID = %d\n", g_subSensor);
                            break;
                        // LGE_CHANGE_S : [2015-10-15] yonghwan.lym@lge.com, Add M2_3G sensor AT Command
                        #if defined(TARGET_MT6582_M23G)
                        case 0x8858:
                            g_subSensor = 8858;
                            PK_DBG(" Sub Sensor found ID = %d\n", g_subSensor);
                        ...
                        case 0x8858: // OV8858 LGIT, COWELL
                            ...
                            break;
                        #endif
                        // LGE_CHANGE_E : [2015-10-15] yonghwan.lym@lge.com, Add M2_3G sensor AT Command
...
#if defined(TARGET_MT6582_M23G)
bool is_m23g_front_camera_5MP()
{
    int s1=0,s2=0,s3=0,model_sel;
    ...
    model_sel = (s3<<2) | (s2<<1) | s1;

	PK_DBG("model_sel = %d\n",model_sel);

	if(model_sel == K410 || model_sel == K410A)
	{
		return 1;// 5MP module
	}
	else
...
// [LGE_UPDATE_S][yonghwan.lym@lge.com][2015-01-29] LGIT and Sunny module check for Y90
	...
	if(module_flag_m23g == -1)
		module_flag_m23g = is_m23g_front_camera_5MP();
#endif
// [LGE_UPDATE_E][yonghwan.lym@lge.com][2015-01-29] LGIT and Sunny module check for Y90
