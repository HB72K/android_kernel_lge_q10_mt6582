...
int TouchGetModelConfig(struct lge_touch_data *pDriverData)
{
	...
	if( np == NULL )
	{
		...
		pConfig->reset_pin = GPIO_TOUCH_RESET;
		pConfig->int_pin = GPIO_TOUCH_INT;
		...
		strcpy(pConfig->fw_image,"synaptics/c90/PLG464-V1.01-PR1741017-DS5.2.12.0.1013-40050181.img");
                #elif defined(TARGET_MT6582_M23G)
                strcpy(pConfig->fw_image,"synaptics/m23g/PLG465-V0.01-PR1741017-DS5.2.12.0.1013-40050181.img");
		#endif
