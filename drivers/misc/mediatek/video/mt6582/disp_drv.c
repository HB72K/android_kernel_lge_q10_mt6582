...
extern unsigned gbackupAddress;
...
#if defined(TARGET_MT6582_Y50)  /* LGE_BSP_COMMON LGE_CHANGE_S 150126 jongwoo82.lee : YK LGD panel dualization */
...
#if defined(TARGET_MT6582_Y50)  /* LGE_BSP_COMMON LGE_CHANGE_S 150126 jongwoo82.lee : YK LGD panel dualization */
        lcm_id = simple_strtol(p, NULL, 10);
#endif  /* LGE_BSP_COMMON LGE_CHANGE_E 150126 jongwoo82.lee : YK LGD panel dualization */
