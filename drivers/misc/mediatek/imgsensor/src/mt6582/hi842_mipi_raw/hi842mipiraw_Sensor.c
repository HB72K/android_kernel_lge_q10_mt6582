...
static imgsensor_info_struct imgsensor_info = { 
	...
	.normal_video = {
        ...
        .grabwindow_height = 1836,//2448 //record different mode's height of grabwindow
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 14,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.max_framerate = 300,	
...
//=============================================//write_cmos_sensor();
write_cmos_sensor(0x0000, 0x0100);//set mirro
...
write_cmos_sensor(0x0012, 0x000c);                         
write_cmos_sensor(0x0018, 0x0cd3);                         
write_cmos_sensor(0x0024, 0x0034);                         
write_cmos_sensor(0x002a, 0x003f);                         
write_cmos_sensor(0x0026, 0x0048);                         
write_cmos_sensor(0x002c, 0x09d7);
write_cmos_sensor(0x005c, 0x0408);
write_cmos_sensor(0x0032, 0x3311);
//write_cmos_sensor(0x0006, 0x09c8);//frame length lines
write_cmos_sensor(0x0006, 0x09dc);
write_cmos_sensor(0x0a22, 0x0100);                    
write_cmos_sensor(0x0a12, 0x0660);//x output size     
write_cmos_sensor(0x0a14, 0x04c8);//y output size                                            
write_cmos_sensor(0x0a04, 0x0162);//ISP EN     
//========================================================
...
write_cmos_sensor(0x090c, 0x0b44);
write_cmos_sensor(0x090e, 0x001e);
//sleep off                                       
write_cmos_sensor(0x0a00, 0x0100);                              
}
...
write_cmos_sensor(0x0018, 0x0ccf);               
...
write_cmos_sensor(0x0006, 0x09dc);                
write_cmos_sensor(0x0a22, 0x0000);
//write_cmos_sensor(0x0a12, 0x0c80);
//write_cmos_sensor(0x0a14, 0x0960);
write_cmos_sensor(0x0a12, 0x0cc0);//x output size 
write_cmos_sensor(0x0a14, 0x0990);//y output size 
write_cmos_sensor(0x0a04, 0x0142);//ISP EN        
//========================================================
...
write_cmos_sensor(0x091c, 0x0f07);              
write_cmos_sensor(0x091e, 0x0a00);              
write_cmos_sensor(0x090c, 0x16b5);              
write_cmos_sensor(0x090e, 0x006a);              
...
write_cmos_sensor(0x0012, 0x000c);                              
write_cmos_sensor(0x0018, 0x0cd3);                              
write_cmos_sensor(0x0024, 0x003a);//0x0038
write_cmos_sensor(0x002a, 0x0045);//0x0043
write_cmos_sensor(0x0026, 0x017a);//0x0048
write_cmos_sensor(0x002c, 0x08a5);//0x09d7
write_cmos_sensor(0x005c, 0x0202);//0x0404
write_cmos_sensor(0x0032, 0x1111);
//write_cmos_sensor(0x0006, 0x09c8);
write_cmos_sensor(0x0006, 0x09c8);//0x9dc
write_cmos_sensor(0x0a22, 0x0000); 
write_cmos_sensor(0x0a12, 0x0cc0);
write_cmos_sensor(0x0a14, 0x072c);//0x0990
write_cmos_sensor(0x0a04, 0x014a);//0x0142

write_cmos_sensor(0x0914, 0xc109);//0xc10c
write_cmos_sensor(0x0916, 0x061a);//0x051a
write_cmos_sensor(0x0918, 0x0307);
write_cmos_sensor(0x091a, 0x0a0a);                               
write_cmos_sensor(0x091c, 0x0f07);                               
write_cmos_sensor(0x091e, 0x0300);//0x0a00
write_cmos_sensor(0x090c, 0x0d7c);//0x16b5
write_cmos_sensor(0x090e, 0x0077);//0x006a
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
   ...
   sensor_info->SensorOutputDataFormat = imgsensor_info.sensor_output_dataformat;
    ...
    switch (scenario_id) {
        ...
        case MSDK_SCENARIO_ID_CAMERA_ZSD: //for 82
