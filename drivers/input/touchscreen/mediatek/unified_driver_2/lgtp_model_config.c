...
#if defined ( TOUCH_DEVICE_S3528 )
extern TouchDeviceSpecificFunction S3528_Func;
#endif

#if defined ( TOUCH_DEVICE_S7020 )
extern TouchDeviceSpecificFunction S7020_Func;
#endif
static TouchDeviceSpecificFunction *pDeviceSpecificFunction[MAX_DEVICE_SUPPORT] = {
	...
	#elif defined ( TOUCH_MODEL_C70 ) || defined ( TOUCH_MODEL_C90 ) || defined ( TOUCH_MODEL_Y90 ) || defined ( TOUCH_MODEL_Y70 ) || defined ( TOUCH_MODEL_M23G )
...
void TouchAssertResetModel( void )
{
	...
	#elif defined ( TOUCH_MODEL_Y90 ) || defined ( TOUCH_MODEL_Y70 ) \
				|| defined ( TOUCH_MODEL_C90 ) || defined ( TOUCH_MODEL_B2L ) \
				|| defined ( TOUCH_MODEL_L80 ) || defined ( TOUCH_MODEL_M23G )
